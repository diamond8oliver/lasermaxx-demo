    ...
    <div className="min-h-screen bg-lm-charcoal flex flex-col">
      ...
      <header className="h-14 bg-lm-black border-b border-lm-mid flex items-center justify-between px-6 shrink-0">
        <div className="flex items-center gap-6">
          <h1 className="text-lm-cyan font-bold text-lg tracking-[0.2em] uppercase">
            LASERMAXX CONTROL
          </h1>
          <span className="text-xs font-bold uppercase tracking-wider text-lm-cyan/70 border border-lm-cyan/30 rounded-full px-3 py-1">
            STAFF PANEL
          </span>
        </div>
        <div className="flex items-center gap-3">
          <span className="inline-block w-2 h-2 rounded-full bg-lm-cyan animate-pulse" />
